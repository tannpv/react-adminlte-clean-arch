...
export class Product {
  ...
  set storeId(value: number | null | undefined) {
    this.props.storeId = value ?? null;
  }

  get sellerId() {
    return this.props.sellerId ?? null;
  }
  set sellerId(value: number | null | undefined) {
    this.props.sellerId = value ?? null;
  }
