...
func (s *UserService) GetUsers(ctx context.Context, req *shared_dto.PaginationRequest) (*shared_dto.PaginationResponse[*dto.UserResponse], error) {
	...
	return shared_dto.NewPaginationResponse(userResponses, total, req.Page, req.Limit), nil
}
