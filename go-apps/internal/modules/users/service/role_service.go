...
func (s *RoleService) GetRoles(ctx context.Context, req *shared_dto.PaginationRequest) (*shared_dto.PaginationResponse[*dto.RoleResponse], error) {
	...
	return shared_dto.NewPaginationResponse(roleResponses, total, req.Page, req.Limit), nil
}
