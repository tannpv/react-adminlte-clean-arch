...
let UsersService = class UsersService {
    constructor(users, rolesService, passwordService, events) {
        this.users = users;
    ...
    async list() {
        ...
        return users.map((user) => (0, user_mapper_1.toUserResponse)(user));
    }
    async findById(id) {
    ...
    async create(dto) {
        ...
        this.events.publish(new user_created_event_1.UserCreatedEvent(created));
        return (0, user_mapper_1.toUserResponse)(created);
    }
    async update(id, dto) {
        ...
        this.events.publish(new user_updated_event_1.UserUpdatedEvent(saved));
    ...
    async remove(id) {
        ...
        if (!removed)
            throw new common_1.NotFoundException({ message: 'Not found' });
        this.events.publish(new user_removed_event_1.UserRemovedEvent(removed));
        return (0, user_mapper_1.toUserResponse)(removed);
    }
