...
exports.UserUpdateValidationService = void 0;
...
let UserUpdateValidationService = class UserUpdateValidationService extends base_validator_service_1.BaseValidatorService {
    constructor(users, roles) {
        super();
        this.users = users;
        this.roles = roles;
    }
    async validate(data, userId) {
        const errors = {};
    ...
    async validateEmailUniqueness(email, userId) {
    ...
    validatePasswordField(password) {
        return common_validators_1.CommonValidators.validatePassword(password);
    }
    validateFirstName(firstName) {
        return common_validators_1.CommonValidators.validateOptionalString(firstName, 'firstName', 2);
    }
    validateLastName(lastName) {
        return common_validators_1.CommonValidators.validateOptionalString(lastName, 'lastName', 2);
    }
...
exports.UserUpdateValidationService = UserUpdateValidationService;
exports.UserUpdateValidationService = UserUpdateValidationService = __decorate([
...
//# sourceMappingURL=user-update-validation.service.js.map