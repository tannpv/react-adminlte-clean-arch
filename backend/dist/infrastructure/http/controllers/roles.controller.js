...
const roles_service_1 = require("../../../application/services/roles.service");
const jwt_auth_guard_1 = require("../guards/jwt-auth.guard");
const permissions_guard_1 = require("../guards/permissions.guard");
const permissions_decorator_1 = require("../decorators/permissions.decorator");
const create_role_dto_1 = require("../../../application/dto/create-role.dto");
const update_role_dto_1 = require("../../../application/dto/update-role.dto");
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequireAnyPermission)('roles:read', 'users:create', 'users:update'),
