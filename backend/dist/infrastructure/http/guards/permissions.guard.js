...
let PermissionsGuard = class PermissionsGuard {
    constructor(reflector, authorization) {
        this.reflector = reflector;
        this.authorization = authorization;
    }
    async canActivate(context) {
        const requirement = this.reflector.getAllAndOverride(permissions_decorator_1.PERMISSIONS_METADATA_KEY, [context.getHandler(), context.getClass()]);
        if (!requirement)
            return true;
