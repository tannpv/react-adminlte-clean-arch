...
export const TRANSLATION_REPOSITORY = "TRANSLATION_REPOSITORY";
export const TRANSLATION_KEY_REPOSITORY = "TRANSLATION_KEY_REPOSITORY";
export const TRANSLATION_NAMESPACE_REPOSITORY =
  "TRANSLATION_NAMESPACE_REPOSITORY";

export interface TranslationRepository {
  findByLanguageAndNamespace(
    languageCode: string,
    namespace: string
  ): Promise<Record<string, string>>;
  findByLanguageAndKeyPath(
    languageCode: string,
    keyPath: string
  ): Promise<string | null>;
  findById(id: number): Promise<Translation | null>;
  findByKeyId(keyId: number): Promise<Translation[]>;
