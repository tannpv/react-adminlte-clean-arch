...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <nav className="bg-white shadow-lg border-b border-gray-200 px-6 py-4 flex justify-between items-center w-full">
      ...
      <aside className="w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white flex-shrink-0 shadow-xl">
        ...
        <div className="p-4">
          <nav className="mt-2">
            <div className="space-y-2">
              ...
              <button 
                className={`w-full flex items-center py-3 px-4 rounded-lg text-white transition-all duration-200 group ${
                  menu === 'users' 
